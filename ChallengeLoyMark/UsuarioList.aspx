                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Acciones" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="240" FooterStyle-Width="150" ItemStyle-Width="250px">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:LinkButton ID="ibtnModificar" runat="server" CssClass="btn btn-outline-yellow dim" Text="Eliminar" CausesValidation="false" ToolTip="Modificar" OnClientClick=<%# string.Format("location.href='UsuarioCRUD.aspx?edit=1&id={0}'; return false;", Eval("id_usuario")) %>><i class="fa fa-edit"></i></asp:LinkButton>
                                                            <asp:LinkButton ID="ibtnEliminar" runat="server" CssClass="btn btn-outline-red dim" CausesValidation="false" ToolTip="Eliminar" CommandName="Eliminar" CommandArgument='<%# Eval("id_usuario")%>'><i class="fa fa-trash-o"></i></asp:LinkButton>
                                                        </ItemTemplate>
